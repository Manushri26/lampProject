...
<!-- navbar-end -->
    ...
    ?>
    <center><body><br><br>
        <h1><p style="color:#003153">Delete Data</p></h1><br>
        <form action="" method="post" id="quiz-form">
            <input type="text" name="roll" id="roll" placeholder="Roll number" required="required" value="<?php echo $str1; ?>"/><span class="error">* <?php echo $idErr;?></span><br><br><br>
            <input type="submit" name="op" class="btn btn-danger ml-3" value="Delete" /> &nbsp&nbsp&nbsp&nbsp
