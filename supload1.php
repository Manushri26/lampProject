...
<?php include 'sfilesLogic.php';?>
  <body ><center>
    <div class="container">
      <div class="row">
        <form action="supload1.php" method="post" enctype="multipart/form-data" >
          <h3>Upload File</h3><br><br>
          <input type="file" name="myfile">
          <button type="submit" name="save" class="btn btn-danger ml-3">upload</button>  
        </form>
      </div>
    </div></center><br><br><br>
			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="assignment.php" class="btn btn-danger ml-3">Back</a>&emsp;&emsp;&emsp;
			&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="welcome.php" class="btn btn-danger ml-3">Home</a>
  </body>
</html>